        ...
        QGCFlickable {
            ...
            width:  Math.max(_root.width, settingsColumn.width)
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            FactCheckBox {
                                ...
                                enabled:        _enforceChecklist.value
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Repeater {
                                    ...
                                    property var names: [ qsTr("SKYNET FC"), qsTr("SiK Radio"), qsTr("PX4 Flow"), qsTr("LibrePilot"), qsTr("UDP"), qsTr("RTK GPS") ]
                    ...
                    QGCLabel {
                        text:               qsTr(" skynet Version V_0.12")
                        Layout.alignment:   Qt.AlignHCenter
                    }
                    QGCLabel {
